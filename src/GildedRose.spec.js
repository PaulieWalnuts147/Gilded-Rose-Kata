    ...
    describe("Sulfuras, Hand of Ragnaros item, ", () => {
        ...
        describe("item sell in", () => {
            ...
            it("does not change the sell in", () => {
                const gildedRose = new GildedRose([new Item(item_name, 5, 0)]);
        ...
        describe("item quality", () => {
            //runSharedTestsItemQualityValue(item_name); //doesn't apply to Sulfuras

            it("quality for Sulfurus is 80 no matter what and it does not change", function () {
            ...
            it("does not change the quality 2", function () {
                const gildedRose = new GildedRose([new Item(item_name, 0, 2)]);
